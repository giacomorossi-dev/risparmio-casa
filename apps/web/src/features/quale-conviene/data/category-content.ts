// Testo lungo (intro/guida/sezioni/FAQ) delle categorie. Importato SOLO dalla
// route $category: così la prosa (~50 KB gz) resta fuori dal chunk della landing.
